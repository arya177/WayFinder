...
public class BluetoothClient {
    ...
    private void processScanResult(@NonNull ScanResult scanResult) {
        if (Objects.equals(scanResult.getBleDevice().getName(), "RDL51822")) {
    ...
    private static IBeaconLocationProvider<IBeacon> createDebuggingLocationProvider(IBeacon iBeacon) {
        ...
        switch (iBeacon.getMacAddress()) {
            case "F2:C9:AD:6D:0E:12": {
                beaconLocation.setLatitude(21.1627664);
                beaconLocation.setLongitude(72.7898373);
                beaconLocation.setAltitude(36);
                break;
            }
            case "E5:A6:A2:29:62:7E" : {
                beaconLocation.setLatitude(21.1627832);
                beaconLocation.setLongitude(72.7898361);
                beaconLocation.setElevation(2.65);
                beaconLocation.setAltitude(36);
                break;
            }
            case "D7:7E:43:C6:E7:04" : {
                beaconLocation.setLatitude(21.1627486);
                beaconLocation.setLongitude(72.789861);
                beaconLocation.setElevation(2.65);
                beaconLocation.setAltitude(36);
                break;
            }
...
//            }
            default:
                throw new IllegalStateException("Unexpected value: " + iBeacon.getMacAddress());
        }
